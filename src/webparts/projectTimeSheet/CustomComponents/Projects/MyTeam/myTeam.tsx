import {React,Dropdown,Box,IProjectProps,Avatar,IDropdownOption,Label,SearchBox,Grid,useState,useEffect,projectsInitialState,getProjectListData,getJobListData,jobsInitialState,JobsData} from "../../../../../index";
  ...
  return (
    <React.Fragment>
      ...
      <Box sx={{ height: "255px", overflowY: "scroll", marginTop: "-23px" }}>
              ...
              if (row.ReportingManager) {
                ...
                try {
                  ...
                  if (parsedData && parsedData[0]) {
                    ...
                    const email = parsedData[0].match(/secondaryText":"([^"]+)"/);
                    if (email) {
                ...
                try {
                  ...
                  if (parsedData && parsedData[0] && parsedData[0].name !== undefined && parsedData[0].name !== "") {
                ...
                let projectTeamName = "-";
                try {
                  if (row.ProjectTeam && row.ProjectTeam[0] && row.ProjectTeam[0].name !== undefined && row.ProjectTeam[0].name !== "") {
                ...
                return (
                  <Grid item key={index} xs={12} sm={6} md={3}>
                    ...
                    >
                      ...
                      <Box
                        sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "5px" }}
                      >
