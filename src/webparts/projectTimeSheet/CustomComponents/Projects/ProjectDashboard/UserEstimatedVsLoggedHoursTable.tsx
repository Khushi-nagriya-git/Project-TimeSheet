...
const UserEstimatedVsLoggedHoursTable = (props: {
  data: any;
  columnName: any;
  ...
  return (
    ...
    >
      ...
      >
        Team Member - Estimated Vs Logged hours
      </Label>
            ...
            {props.data.map((data: any) => {
              return (
                <TableRow key={data.JobName}>
                  ...
                  >
                    {convertMinutesToHoursAndMinutes(data.CalculateEstimateHours)}
                  </TableCell>
                  <TableCell
                    align="center"
                    sx={{
                  ...
                  >
                    {convertMinutesToHoursAndMinutes(data.CalculateLoggedHours)}
                  </TableCell>
                </TableRow>
              );
            })}
